...
[Original LeetGPU Challenge](https://leetgpu.com/challenges/rms-normalization)
...
RMS Normalization computes: $$ \begin{align} \text{rms} &= \sqrt{\frac{1}{N} \sum\_{i=1}^{N} x_i^2 + \epsilon} \\ \hat{x}\_i &= \frac{x_i}{\text{rms}} \\ y_i &= \gamma \hat{x}\_i + \beta \end{align} $$

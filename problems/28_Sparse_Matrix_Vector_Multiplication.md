...
[Original LeetGPU Challenge](https://leetgpu.com/challenges/sparse-matrix-vector-multiplication)
...
Mathematically, the operation is defined as: $$ y_i = \sum\_{j=0}^{N-1} A\_{ij} \cdot x_j \quad \text{for} \quad i = 0, 1, \ldots, M-1 $$
...
Input:  
Matrix $A$ ($3 \times 4$): $$ \begin{bmatrix} 5.0 & 0.0 & 0.0 & 1.0 \\ 0.0 & 2.0 & 3.0 & 0.0 \\ 0.0 & 0.0 & 0.0 & 4.0 \end{bmatrix} $$ Vector $x$: $$ \begin{bmatrix} 1.0 \\ 2.0 \\ 3.0 \\ 4.0 \end{bmatrix} $$ Output:  
Vector $y$: $$ \begin{bmatrix} 9.0 \\ 13.0 \\ 16.0 \end{bmatrix} $$

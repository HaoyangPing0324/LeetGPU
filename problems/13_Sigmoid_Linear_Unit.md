...
[Original LeetGPU Challenge](https://leetgpu.com/challenges/sigmoid-linear-unit)
...
SiLU is defined as: $$ \begin{align} \sigma(x) &= \frac{1}{1 + e^{-x}} \\ \text{SiLU}(x) &= x \cdot \sigma(x) \end{align} $$

...
[Original LeetGPU Challenge](https://leetgpu.com/challenges/all-pairs-shortest-paths)
...
$$ \text{output}\[i\]\[j\] = \min\\\bigl(\text{output}\[i\]\[j\],\\ \text{output}\[i\]\[k\] + \text{output}\[k\]\[j\]\bigr) \quad \forall\\ i, j $$
